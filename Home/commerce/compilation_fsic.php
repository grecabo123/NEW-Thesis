                ...
                <div class="container-fluid d-block">
                    <!-- <div class="list-group-item bg-transparent list"> -->
                        <li class="list-group text-justify list-group-item bg-transparent list">
                            <a class="bg-transparent second-text fw-bold text-primary-active fsic-business text-primary">FSIC(Business Permit)</a>
                        </li>                    <!-- </div> -->
                </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="col-md-12" class="form-label">
                                        <button disabled id="submit" class="btn btn-primary" value="<?php echo $user_id; ?>" onclick="Update_fsic();">Submit</button>
