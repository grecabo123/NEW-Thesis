                ...
                <div class="container">
                    <div class="modal-content">
                        <div class="modal-header bg-secondary">
                            <div class="col-md-12">
                                <h3 class="text-left modal-title fw-bold text-light">Notice To Correction</h3>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 text_font">
                                    <span class="terms"><span class="fw-bold">Note:</span> <ul>
                                        ...
                                        <li><small class="text-secondary">Send a Validation Payment To proceed</small></li>
                                    </ul></span>
                                </div>
                            </div>
                        </div>
                        <div class="modal-body">
                            <!-- <form method="post" class="form-group"> -->
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="file" class="form-control" id="file_admin" value="<?php echo $user_owner; ?>" readonly>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <button class="btn btn-primary" id="submit" value="<?php echo $user_id; ?>" disabled>Submit & Ready</button>
