<?php  
	...
	$update = "UPDATE tbl_service_type SET building_specification ='$permit_num1',bill_material='$permit_num2',bfp_or='$permit_num3',status_cro='$remark',voltage_circuit='$permit_num4' WHERE tbl_info_fk = $fk";
