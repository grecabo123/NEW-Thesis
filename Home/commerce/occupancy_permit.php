    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark-color" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="market" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
                <a style="cursor: pointer;" href="status" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-comment-dots me-2"></i>Status</a>
                <a href="message" style="cursor: pointer;" class="list-group-item list-group-item-action bg-transparent second-text fw-bold chat-modal"><i class="fas fa-comment me-2"></i>Message <span class="badge bg-danger notification"></span></a>
                ...
                <div class="container-fluid d-block">
                    <!-- <div class="list-group-item bg-transparent list"> -->
                        <li class="list-group text-justify list-group-item bg-transparent list">
                            <a href="fsic_permit" class="bg-transparent second-text fw-bold ">FSIC(Business Permit)</a>
                        </li>
                        <li class="list-group text-left list-group-item bg-transparent list">
                            <a href="fsec_permit" class="bg-transparent second-text fw-bold">FSEC (Building Permit)</a>
                        </li>
                        <li class="list-group text-left list-group-item bg-transparent list">
                            <a href="occupancy_permit" class="bg-transparent second-text fw-bold text-primary">FSIC (Occupancy Permit)</a>
                        </li>
                    <!-- </div> -->
                </div>
                            ...
                            <!-- <form method="post" class="form-group"> -->
                               ...
                               <div class="mb-1">
                                ...
                                <div class="col-md-12" class="form-label">
                                    <button class="btn btn-primary" name="submit" onclick="occupancy();" id="occupancy" disabled>Submit</button>
