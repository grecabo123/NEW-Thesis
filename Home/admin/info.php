...
<head>
    ...
    <link href="../assets/img/Icon/logo.png" rel="icon">
     <link rel="stylesheet" href="../personnel/fses/css/fses.css">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left">Chief Relation Office</td>
                                   
                                    <td class="right"><i class="fas fa-check-circle me-2 text-success" title="Approved"></i></td>
                                </tr>
                                <tr>
                                    <td class="center">1</td>
                                    <td class="left">Chief Fire Code Assessor</td>
                                 
                                    <td class="right"><i class="fas fa-check-circle me-2 text-success" title="Approved"></i></td>
                                </tr>
                                <tr>
                                    <td class="center">1</td>
                                    <td class="left">Fire Chief Collecting Agent</td>
                        ...
                        <div class="col-lg-4 col-sm-5 ml-auto">
                            ...
                            <div class="container">
                                <div class="row d-flex">
                                    <div class="col-md-4">
                                 <button class="btn btn-sm btn-success" id="approve" value="<?php echo $service_id; ?>"><i class="fa fa-paper-plane mr-1"></i> Approve</button>
