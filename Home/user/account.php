    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark-color" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a  href="account" class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-primary" style="cursor: pointer;"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="mb-7">
                            ...
                            <input type="text" id="username" value="<?php echo $user_fname; ?>" required placeholder="Name" class="form-control">
                        </div>
                        <div class="mb-7">
                            <label for="" class="form-label">
                                Middle Name
                            ...
                            <input type="text" id="user_mname" value="<?php echo $user_mname; ?>" required placeholder="Middle Name" class="form-control">
                        </div>
                        <div class="mb-7">
                            <label for="" class="form-label">
                                Last Name
                            ...
                            <input type="text" id="user_lname" value="<?php echo $user_lname; ?>" required placeholder="Name" class="form-control">
                        </div>
                         <div class="mb-7">
                            <label for="" class="form-label">
                                Email
                            </label>
                            <input type="text" id="email" required placeholder="Email" readonly value="<?php echo $user_email_a; ?>" class="form-control">
                        </div>
                         <div class="mb-7" class="form-label">
                            <label for="">
                                Barangay
                            </label>
                            <input type="text" id="brgy" required placeholder="Barangay" class="form-control" value="<?php echo $user_brgy; ?>">
                        </div>
                         <div class="mb-7" class="form-label">
                            <label for="">
                                Address
                            </label>
                            <input type="text" id="street" name="address" required placeholder="Street" class="form-control">
                        </div>
                        <div class="mb-7" class="form-label">
                            <label for="">
                                Contact Number                            
                            </label>
                            <input type="text" id="contact_num" name="contact" required placeholder="Contact Number" class="form-control" maxlength="11" value="<?php echo $user_contact; ?>">
                        </div>
                        <br>
                        <div class="mb-7" class="form-label">
                            <label for="">
                            ...
                            <span class="text-success fw-bold"><?php echo $user_acc; ?></span>
                        </div>
                        <br>
