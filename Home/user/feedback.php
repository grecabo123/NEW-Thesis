    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark-color" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a style="cursor: pointer;" class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-primary"><i class="fas fa-comment me-2"></i>Feedback</a>         
