    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark-color" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <!-- end of dropdown -->
                <a href="instruction" class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-primary"><i class="fas fa-chalkboard-teacher me-2"></i>Instruction</a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-12">
                        ...
                        <h3 class="text-left modal-title fw-bold">Instruction</h3>
                    </div>
                </div>
                <div class="modal-body">
                   <ul class="list-group">
                       <li class="nav-link">
                           <a class="text-primary nav-link fw-bold">Incident Type</a>
                           <span class=" text-muted text-wrap text-capitalize">  - the incident type for emergencies such fire, floods and other incidents that needs rescue.</span>
                       </li>
                       <li class="nav-link">
                           <a class="text-primary nav-link fw-bold">Hazard Type</a>
                           <span class=" text-muted text-capitalize">  - The Hazard report type for cases like garbage, or other substance that could cause fire.</span>
                       </li>
                   </ul>
                </div>
            </div>
