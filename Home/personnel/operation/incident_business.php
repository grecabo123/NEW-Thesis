    ...
    <div class="d-flex" id="wrapper">
                ...
                <div class="container-fluid">
                    <!-- <div class="list-group-item bg-transparent list"> -->
                        <li class="list-group text-justify list-group-item bg-transparent list">
                            <a href="incident" class="bg-transparent second-text fw-bold text-primary">Incident Report <span class="badge bg-danger incident_count"></span></a>
                        </li>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="m-4">
                    ...
                    <!-- <div class="container"> -->
                      <select name="" id="select_incident" class="form-select w-25">
                ...
                <div class="incident_modal">
                  <div class="w-75 bg-light rounded p-3 col-lg-12 col-sm-12">
                    <div class="col-md-12">
                      <h3 class="text-muted">Incident Report</h3>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" value="" class="form-control" readonly id="incident">
                      </div>
                      <div class="col-md-6">
                        <label for="" class="form-label fw-bold">
                          Barangay:
...
?>
    ...
    <script src="js/incident_business.js"></script>
